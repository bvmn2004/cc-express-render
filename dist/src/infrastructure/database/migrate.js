    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `);
            ...
            `);
                ...
                `;
                    yield db_1.default.query(`INSERT INTO blogs (title, content, product_id)
                     VALUES ($1, $2, $3)`, [blogTitle, blogContent, product.id]);
        ...
        `);
            ...
            const checkCategories = yield db_1.default.query("SELECT COUNT(*) FROM categories");
            ...
            const checkUsers = yield db_1.default.query("SELECT COUNT(*) FROM users");
            ...
            const checkProducts = yield db_1.default.query("SELECT COUNT(*) FROM products");
            ...
            const checkPromotions = yield db_1.default.query("SELECT COUNT(*) FROM promotions");
